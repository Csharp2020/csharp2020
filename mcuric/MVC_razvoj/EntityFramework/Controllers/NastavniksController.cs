...
namespace EntityFramework.Controllers
{
    public class NastavniksController : Controller
    {
        ...
        {
            int pageSize = 10;
            var nastavniks = _context.Nastavnik.Include(n => n.PbrStanNavigation).Include(n => n.SifOrgjedNavigation);
            return View(await PaginatedList<Nastavnik>.CreateAsync(nastavniks.AsNoTracking(), pageNumber ?? 1, pageSize));
